...
-- Table: DishType
CREATE TABLE IF NOT EXISTS DishType (dtid INTEGER PRIMARY KEY, name TEXT UNIQUE) WITHOUT ROWID;
INSERT INTO DishType (dtid, name) VALUES (1, 'Sandwiches & Wraps');
INSERT INTO DishType (dtid, name) VALUES (2, 'Soups and Stews');
INSERT INTO DishType (dtid, name) VALUES (3, 'Pie');
INSERT INTO DishType (dtid, name) VALUES (4, 'BBQ and Grilling');
INSERT INTO DishType (dtid, name) VALUES (5, 'Casserole');
INSERT INTO DishType (dtid, name) VALUES (6, 'Meats');
INSERT INTO DishType (dtid, name) VALUES (7, 'Pasta');
INSERT INTO DishType (dtid, name) VALUES (8, 'Pizza');
INSERT INTO DishType (dtid, name) VALUES (9, 'Rice and Beans');
INSERT INTO DishType (dtid, name) VALUES (10, 'Salad');
INSERT INTO DishType (dtid, name) VALUES (11, 'Stir-fry');

-- Table: Ingredient
CREATE TABLE IF NOT EXISTS Ingredient (iid INTEGER PRIMARY KEY, name TEXT UNIQUE) WITHOUT ROWID;
INSERT INTO Ingredient (iid, name) VALUES (1, 'Dry Ziti');
INSERT INTO Ingredient (iid, name) VALUES (2, 'Onion');
INSERT INTO Ingredient (iid, name) VALUES (3, 'Lean Ground Beef');
INSERT INTO Ingredient (iid, name) VALUES (4, 'Spaghetti Sauce');
INSERT INTO Ingredient (iid, name) VALUES (5, 'Provolone Cheese');
INSERT INTO Ingredient (iid, name) VALUES (6, 'Sour Cream');
INSERT INTO Ingredient (iid, name) VALUES (7, 'Mozzarella Cheese');
INSERT INTO Ingredient (iid, name) VALUES (8, 'Parmesan Cheese');
INSERT INTO Ingredient (iid, name) VALUES (9, 'Bone in Chicken Thigh Fillets');
INSERT INTO Ingredient (iid, name) VALUES (10, 'Garlic');
INSERT INTO Ingredient (iid, name) VALUES (11, 'Butter');
INSERT INTO Ingredient (iid, name) VALUES (12, 'White Rice');
INSERT INTO Ingredient (iid, name) VALUES (13, 'Chicken Stock');
INSERT INTO Ingredient (iid, name) VALUES (14, 'Water');
INSERT INTO Ingredient (iid, name) VALUES (15, 'Paprika Powder');
INSERT INTO Ingredient (iid, name) VALUES (16, 'Dried Thyme');
INSERT INTO Ingredient (iid, name) VALUES (17, 'Garlic Powder');
INSERT INTO Ingredient (iid, name) VALUES (18, 'Onion Powder');
INSERT INTO Ingredient (iid, name) VALUES (19, 'Salt');
INSERT INTO Ingredient (iid, name) VALUES (20, 'Black Pepper');
INSERT INTO Ingredient (iid, name) VALUES (21, 'Colby Jack Cheese');
INSERT INTO Ingredient (iid, name) VALUES (22, 'Chili Powder');
INSERT INTO Ingredient (iid, name) VALUES (23, 'Cajun Seasoning');
INSERT INTO Ingredient (iid, name) VALUES (24, 'Cayenne Pepper Seasoning');
INSERT INTO Ingredient (iid, name) VALUES (25, 'Flavor Bomb Burger Seasoning');

-- Table: Measurement
CREATE TABLE IF NOT EXISTS Measurement (mid INTEGER PRIMARY KEY, name TEXT UNIQUE) WITHOUT ROWID;
INSERT INTO Measurement (mid, name) VALUES (1, 'Teaspoon');
INSERT INTO Measurement (mid, name) VALUES (2, 'Tablespoon');
INSERT INTO Measurement (mid, name) VALUES (3, 'Ounce');
INSERT INTO Measurement (mid, name) VALUES (4, 'Cup');
INSERT INTO Measurement (mid, name) VALUES (5, 'Pint');
INSERT INTO Measurement (mid, name) VALUES (6, 'Quart');
INSERT INTO Measurement (mid, name) VALUES (7, 'Gallon');
INSERT INTO Measurement (mid, name) VALUES (8, 'Fluid Ounce');
INSERT INTO Measurement (mid, name) VALUES (9, 'Pound');
INSERT INTO Measurement (mid, name) VALUES (10, 'Milliliter');
INSERT INTO Measurement (mid, name) VALUES (11, 'Liter');
INSERT INTO Measurement (mid, name) VALUES (12, 'Gram');
INSERT INTO Measurement (mid, name) VALUES (13, 'Kilogram');
INSERT INTO Measurement (mid, name) VALUES (14, 'Pinch');
INSERT INTO Measurement (mid, name) VALUES (15, 'Clove');

-- Table: Recipe
CREATE TABLE IF NOT EXISTS Recipe (rid INTEGER PRIMARY KEY, name TEXT, origin TEXT, favorite NUMERIC, image BLOB, num_cooked INTEGER, description TEXT, instructions TEXT, calories INTEGER, carbs INTEGER, fat INTEGER, protein INTEGER, servings INTEGER, prep_time TEXT, cook_time TEXT, total_time TEXT) WITHOUT ROWID;
INSERT INTO Recipe (rid, name, origin, favorite, image, num_cooked, description, instructions, calories, carbs, fat, protein, servings, prep_time, cook_time, total_time) VALUES (1, 'Baked Ziti', 'Italy', 0, NULL, 0, 'Indulge in a comforting Italian classic with our baked ziti recipe. Al dente ziti pasta is tossed in a savory marinara sauce, layered with creamy ricotta cheese, and topped with melted mozzarella for a dish that''s both hearty and satisfying. Baked to golden perfection, this crowd-pleaser is perfect for family dinners or gatherings with friends.', 'Requires a 9x13 pan.\n1. Bring a large pot of lightly salted water to a boil. Add ziti pasta, and cook until al dente, about 8 minutes; drain.\n2. Meanwhile, brown ground beef and onion in a large skillet over medium heat; stir in spaghetti sauce and simmer for 15 minutes.\n3. Preheat the oven to 350 degrees F (175 degrees C). Butter the 9x13-inch baking dish.\n4. Spread one half of the ziti in the bottom of the prepared dish; top with Provolone cheese, sour cream, one half of the meat sauce, remaining ziti, mozzarella cheese, and remaining meat sauce. Top with grated Parmesan cheese.\n5. Bake in the preheated oven until heated through and cheeses have melted, about 30 minutes.', 578, 58, 25, 28, 10, '15 mins', '45 mins', '1 hr');
